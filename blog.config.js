...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '扮忙的小猪', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yxymyog.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,yxy,myog,垚小尧', // 网站关键词 英文逗号隔开
